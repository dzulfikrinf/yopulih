        ...
        <div class="w-full max-w-4xl flex flex-wrap overflow-hidden mx-8">
            <div class="w-full md:w-1/2">
                ...
                <div class="shadow-lg bg-white border-2 border-gray-300 rounded-lg p-8">
                    ...
                    <p class="mb-4">Belum memiliki akun? <a href="/auth/register" class="text-blue-500">Daftar</a></p>
                    <form action="/auth/login" method="POST" class="space-y-5">
                        ...
                        <div>
                            <button type="submit" class="w-full bg-gray-400 text-white py-2 px-4 rounded-md hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Masuk</button>
                        </div>
                    </form>
                </div>
            </div>
